...
import com.ssafy.ws_android_component_07_3_hojojeong.databinding.ActivityStuffBinding
...
class StuffActivity : AppCompatActivity() {
    ...
    private fun modifyEventListener() {
        listviewStuffList.setOnItemClickListener { _, _, position, _ ->
