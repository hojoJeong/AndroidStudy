package com.ssafy.ws_android_component_07_3_hojojeong
...
import com.ssafy.ws_android_component_07_3_hojojeong.databinding.ActivityMainBinding
import com.ssafy.ws_android_component_07_3_hojojeong.dto.StuffDto
import com.ssafy.ws_android_component_07_3_hojojeong.fragment.MainFragment
import com.ssafy.ws_android_component_07_3_hojojeong.fragment.StoreFragment
import com.ssafy.ws_android_component_07_3_hojojeong.service.BoundService
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initData(){
        if(boundService.selectAll().size == 0){
            boundService.insert(StuffDto("사과", 10,1650720030391))
            boundService.insert(StuffDto("참외", 11,1637241743350))
        }
    }
